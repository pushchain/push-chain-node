...
type ChainConfig struct {
	...
	OracleFetchInterval *durationpb.Duration `protobuf:"bytes,8,opt,name=oracle_fetch_interval,json=oracleFetchInterval,proto3" json:"oracle_fetch_interval,omitempty"`
}
...
func (m *ChainConfig) GetOracleFetchInterval() *durationpb.Duration {
	if m != nil {
		return m.OracleFetchInterval
	}
	return nil
}
...
var fileDescriptor_11eea54f17422d86 = []byte{
	...
	,
}
...
func (this *ChainConfig) Equal(that interface{}) bool {
	...
	if !this.OracleFetchInterval.Equal(that1.OracleFetchInterval) {
		return false
	}
	return true
}
...
func (m *ChainConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.OracleFetchInterval != nil {
		{
			size, err := m.OracleFetchInterval.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ChainConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OracleFetchInterval", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.OracleFetchInterval == nil {
				m.OracleFetchInterval = &durationpb.Duration{}
			}
			if err := m.OracleFetchInterval.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
