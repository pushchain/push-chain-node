...
// source: pushchain/pushchain/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c3f0be5d88a9d207, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c3f0be5d88a9d207, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "pushchain.pushchain.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "pushchain.pushchain.QueryParamsResponse")
}

func init() { proto.RegisterFile("pushchain/pushchain/query.proto", fileDescriptor_c3f0be5d88a9d207) }

var fileDescriptor_c3f0be5d88a9d207 = []byte{
	// 282 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2f, 0x28, 0x2d, 0xce,
	0x48, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0xb0, 0x0a, 0x4b, 0x53, 0x8b, 0x2a, 0xf5, 0x0a, 0x8a,
	...
	0xff, 0xff, 0x1c, 0xea, 0x68, 0xed, 0xec, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pushchain.pushchain.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pushchain.pushchain.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pushchain.pushchain.Query",
	...
	Metadata: "pushchain/pushchain/query.proto",
}
