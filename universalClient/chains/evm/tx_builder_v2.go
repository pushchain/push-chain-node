...
// hardcodedVaultAddress is a temporary placeholder used when the gateway VAULT() call is skipped
var hardcodedVaultAddress = ethcommon.HexToAddress("0x0000000000000000000000000000000000000001")
...
// TxBuilderV2 implements OutboundTxBuilder for EVM chains (DEPRECATED - not active)
// This was designed for an older gateway contract version.
// Use TxBuilder for the current UniversalGatewayV0 contract.
...
func (tb *TxBuilderV2) determineTargetContract(ctx context.Context, assetAddr ethcommon.Address) (ethcommon.Address, error) {
...
// getVaultAddress returns the vault address. Temporarily hardcoded to skip the gateway VAULT() call.
func (tb *TxBuilderV2) getVaultAddress(ctx context.Context) (ethcommon.Address, error) {
	return hardcodedVaultAddress, nil
}
...
func (tb *TxBuilderV2) determineFunctionName(txType uetypes.TxType, assetAddr ethcommon.Address, isVault bool) string {
...
func (tb *TxBuilderV2) encodeFunctionCall(
	funcName string,
	data *uetypes.OutboundCreatedEvent,
	amount *big.Int,
...
func (tb *TxBuilderV2) getFunctionSignature(funcName string, isNative bool) string {
	switch funcName {
	case "withdraw":
