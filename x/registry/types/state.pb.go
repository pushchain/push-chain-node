...
// source: registry/v1/state.proto
...
func init() {
	proto.RegisterType((*ExampleData)(nil), "registry.v1.ExampleData")
}

func init() { proto.RegisterFile("registry/v1/state.proto", fileDescriptor_a06572813783339b) }
