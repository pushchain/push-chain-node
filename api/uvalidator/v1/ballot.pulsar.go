...
var _ protoreflect.List = (*_Ballot_5_list)(nil)

type _Ballot_5_list struct {
	list *[]string
}

func (x *_Ballot_5_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Ballot_5_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_Ballot_5_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_Ballot_5_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_Ballot_5_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Ballot at list field Reasons as it is not of Message kind"))
}

func (x *_Ballot_5_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_Ballot_5_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_Ballot_5_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_Ballot_reasons              protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Ballot_reasons = md_Ballot.Fields().ByName("reasons")
...
func (x *fastReflection_Ballot) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Reasons) != 0 {
		value := protoreflect.ValueOfList(&_Ballot_5_list{list: &x.Reasons})
		if !f(fd_Ballot_reasons, value) {
			return
		}
	}
...
func (x *fastReflection_Ballot) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "uvalidator.v1.Ballot.reasons":
		if len(x.Reasons) == 0 {
			return protoreflect.ValueOfList(&_Ballot_5_list{})
		}
		listValue := &_Ballot_5_list{list: &x.Reasons}
		return protoreflect.ValueOfList(listValue)
	case "uvalidator.v1.Ballot.voting_threshold":
...
func (x *fastReflection_Ballot) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "uvalidator.v1.Ballot.reasons":
		...
		value := &_Ballot_5_list{list: &x.Reasons}
		return protoreflect.ValueOfList(value)
	case "uvalidator.v1.Ballot.id":
...
func (x *fastReflection_Ballot) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Reasons) > 0 {
			for iNdEx := len(x.Reasons) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.Reasons[iNdEx])
				copy(dAtA[i:], x.Reasons[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Reasons[iNdEx])))
				i--
				dAtA[i] = 0x2a
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Reasons", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.Reasons = append(x.Reasons, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 6:
				if wireType != 0 {
...
const (
	...
	VoteResult_VOTE_RESULT_YES           VoteResult = 1 // Positive vote
	VoteResult_VOTE_RESULT_NO            VoteResult = 2 // Negative vote
)
...
func (x *Ballot) GetReasons() []string {
	if x != nil {
		return x.Reasons
	}
	return nil
...
var file_uvalidator_v1_ballot_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x03, 0x0a, 0x06, 0x42, 0x61, 0x6c, 0x6c, 0x6f, 0x74, 0x12,
	...
	,
