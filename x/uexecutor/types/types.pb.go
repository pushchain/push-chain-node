...
const (
	...
	InboundTxType_GAS_FUND_TX                  InboundTxType = 1
	InboundTxType_FUNDS_BRIDGE_TX              InboundTxType = 2
	InboundTxType_FUNDS_AND_PAYLOAD_TX         InboundTxType = 3
	InboundTxType_FUNDS_AND_PAYLOAD_INSTANT_TX InboundTxType = 4
)
...
var InboundTxType_name = map[int32]string{
	...
	1: "GAS_FUND_TX",
	2: "FUNDS_BRIDGE_TX",
	3: "FUNDS_AND_PAYLOAD_TX",
	4: "FUNDS_AND_PAYLOAD_INSTANT_TX",
}
...
var InboundTxType_value = map[string]int32{
	...
	"GAS_FUND_TX":                  1,
	"FUNDS_BRIDGE_TX":              2,
	"FUNDS_AND_PAYLOAD_TX":         3,
	"FUNDS_AND_PAYLOAD_INSTANT_TX": 4,
}
...
var fileDescriptor_fab6d3ca71d1e2a5 = []byte{
	...
	,
}
