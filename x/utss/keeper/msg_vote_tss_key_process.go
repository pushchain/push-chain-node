...
func (k Keeper) VoteTssKeyProcess(
	...
	if err := k.updateTssEventStatusByProcessId(ctx, processId, types.TssEventType_TSS_EVENT_PROCESS_INITIATED, types.TssEventStatus_TSS_EVENT_COMPLETED); err != nil {
