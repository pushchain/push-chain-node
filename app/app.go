...
import (
	...
	push "github.com/rollchains/pchain/x/push"
	pushkeeper "github.com/rollchains/pchain/x/push/keeper"
	pushtypes "github.com/rollchains/pchain/x/push/types"
)
...
func NewChainApp(
	...
	// Create the push Keeper
	app.PushKeeper = pushkeeper.NewKeeper(
		appCodec,
		runtime.NewKVStoreService(keys[pushtypes.StoreKey]),
		logger,
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
	)
	...
	app.ModuleManager = module.NewManager(
		...
		push.NewAppModule(appCodec, app.PushKeeper),
	...
	// see cmd/pushd/root.go: 206 - 214 approx
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(pushtypes.ModuleName)
