...
// source: uregistry/v1/state.proto
...
func init() {
	proto.RegisterType((*ExampleData)(nil), "uregistry.v1.ExampleData")
}

func init() { proto.RegisterFile("uregistry/v1/state.proto", fileDescriptor_a06572813783339b) }
