...
func (x *_Ballot_3_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Ballot at list field VoterList as it is not of Message kind"))
}
...
var (
	...
	fd_Ballot_voter_list           protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Ballot_voter_list = md_Ballot.Fields().ByName("voter_list")
...
func (x *fastReflection_Ballot) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.VoterList) != 0 {
		value := protoreflect.ValueOfList(&_Ballot_3_list{list: &x.VoterList})
		if !f(fd_Ballot_voter_list, value) {
			return
		}
	}
	if len(x.Votes) != 0 {
...
func (x *fastReflection_Ballot) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "uvalidator.v1.Ballot.voter_list":
		return len(x.VoterList) != 0
...
func (x *fastReflection_Ballot) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "uvalidator.v1.Ballot.voter_list":
		...
		listValue := &_Ballot_3_list{list: &x.VoterList}
...
func (x *fastReflection_Ballot) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "uvalidator.v1.Ballot.voter_list":
		...
		value := &_Ballot_3_list{list: &x.VoterList}
...
func (x *fastReflection_Ballot) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.VoterList) > 0 {
			for iNdEx := len(x.VoterList) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.VoterList[iNdEx])
				copy(dAtA[i:], x.VoterList[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.VoterList[iNdEx])))
				i--
				dAtA[i] = 0x1a
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field VoterList", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.VoterList = append(x.VoterList, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 4:
				if wireType == 0 {
					var v VoteResult
...
type Ballot struct {
	...
	VoterList          []string              `protobuf:"bytes,3,rep,name=voter_list,json=voterList,proto3" json:"voter_list,omitempty"`                                              // Snapshot of allowed voters at creation
...
func (x *Ballot) GetVoterList() []string {
	if x != nil {
		return x.VoterList
	}
	return nil
...
var file_uvalidator_v1_ballot_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x03, 0x0a, 0x06, 0x42, 0x61, 0x6c, 0x6c, 0x6f, 0x74, 0x12,
	...
	,
	...
	0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x12,
	...
	0x68, 0x74, 0x5f, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x55, 0x4e, 0x44, 0x5f, 0x54, 0x58, 0x10, 0x02, 0x1a, 0x04, 0xa8, 0xa4, 0x1e, 0x01, 0x2a, 0x5a,
	...
	0x59, 0x45, 0x54, 0x5f, 0x56, 0x4f, 0x54, 0x45, 0x44, 0x10, 0x00, 0x12, 0x13, 0x0a, 0x0f, 0x56,
	0x4f, 0x54, 0x45, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x5f, 0x59, 0x45, 0x53, 0x10, 0x01,
	0x12, 0x12, 0x0a, 0x0e, 0x56, 0x4f, 0x54, 0x45, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x5f,
	0x4e, 0x4f, 0x10, 0x02, 0x1a, 0x04, 0xa8, 0xa4, 0x1e, 0x01, 0x42, 0xb2, 0x01, 0x0a, 0x11, 0x63,
	0x6f, 0x6d, 0x2e, 0x75, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x76, 0x31,
	0x42, 0x0b, 0x42, 0x61, 0x6c, 0x6c, 0x6f, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
