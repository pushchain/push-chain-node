...
CHAIN_ID="push_42101-1" MONIKER=pn1 HOME_DIR="~/.pchain" BLOCK_TIME="1000ms" CLEAN=true ./test_node.sh
```
...
cd ~/app
CHAIN_ID="push_42101-1" MONIKER=pn1 HOME_DIR="~/.pchain" BLOCK_TIME="1000ms" CLEAN=true ./make_first_node.sh
# CTRL-C to stop
