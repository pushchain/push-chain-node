...
type MsgVoteOutbound struct {
	// signer is the Cosmos address initiating the tx (used for tx signing)
	Signer     string               `protobuf:"bytes,1,opt,name=signer,proto3" json:"signer,omitempty"`
	UtxId      string               `protobuf:"bytes,2,opt,name=utx_id,json=utxId,proto3" json:"utx_id,omitempty"`
	OutboundId string               `protobuf:"bytes,3,opt,name=outbound_id,json=outboundId,proto3" json:"outbound_id,omitempty"`
...
func (m *MsgVoteOutbound) GetOutboundId() string {
	if m != nil {
		return m.OutboundId
	}
	return ""
...
var fileDescriptor_88d6216044506365 = []byte{
	...
	,
}
