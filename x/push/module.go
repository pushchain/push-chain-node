...
import (
	...
	"github.com/rollchains/pchain/x/push/keeper"
	"github.com/rollchains/pchain/x/push/types"
)

const (
	// ConsensusVersion defines the current x/push module consensus version.
	ConsensusVersion = 1
)
