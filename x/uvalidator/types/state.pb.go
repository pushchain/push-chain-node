...
// source: uvalidator/v1/state.proto
...
func init() {
	proto.RegisterType((*ExampleData)(nil), "uvalidator.v1.ExampleData")
}

func init() { proto.RegisterFile("uvalidator/v1/state.proto", fileDescriptor_a06572813783339b) }
