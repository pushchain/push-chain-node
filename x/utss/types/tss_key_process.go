...
func (p TssKeyProcess) ValidateBasic() error {
	...
	if p.ProcessType != TssProcessType_TSS_PROCESS_KEYGEN && p.ProcessType != TssProcessType_TSS_PROCESS_REFRESH && p.ProcessType != TssProcessType_TSS_PROCESS_QUORUM_CHANGE {
