...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		pushchainmodule.AppModuleBasic{},
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		pushchainmoduletypes.StoreKey,evmtypes.StoreKey,feemarkettypes.StoreKey,
	...
	*/
	...
	app.PushchainKeeper = *pushchainmodulekeeper.NewKeeper(
		appCodec,
		keys[pushchainmoduletypes.StoreKey],
		keys[pushchainmoduletypes.MemStoreKey],
		app.GetSubspace(pushchainmoduletypes.ModuleName),
	)
	pushchainModule := pushchainmodule.NewAppModule(appCodec, app.PushchainKeeper, app.AccountKeeper, app.BankKeeper)
