...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cc90e16cf6966ee, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cc90e16cf6966ee, []int{1}
}
...
func (m *MsgVoteReadResult) Reset()         { *m = MsgVoteReadResult{} }
func (m *MsgVoteReadResult) String() string { return proto.CompactTextString(m) }
func (*MsgVoteReadResult) ProtoMessage()    {}
func (*MsgVoteReadResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cc90e16cf6966ee, []int{2}
}
...
func (m *MsgVoteReadResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgVoteReadResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgVoteReadResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgVoteReadResult.Merge(m, src)
}
func (m *MsgVoteReadResult) XXX_Size() int {
	return m.Size()
}
func (m *MsgVoteReadResult) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgVoteReadResult.DiscardUnknown(m)
}

var xxx_messageInfo_MsgVoteReadResult proto.InternalMessageInfo
...
func (m *MsgVoteReadResultResponse) Reset()         { *m = MsgVoteReadResultResponse{} }
func (m *MsgVoteReadResultResponse) String() string { return proto.CompactTextString(m) }
func (*MsgVoteReadResultResponse) ProtoMessage()    {}
func (*MsgVoteReadResultResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cc90e16cf6966ee, []int{3}
}
...
func (m *MsgVoteReadResultResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgVoteReadResultResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgVoteReadResultResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgVoteReadResultResponse.Merge(m, src)
}
func (m *MsgVoteReadResultResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgVoteReadResultResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgVoteReadResultResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgVoteReadResultResponse proto.InternalMessageInfo
...
func (c *msgClient) VoteReadResult(ctx context.Context, in *MsgVoteReadResult, opts ...grpc.CallOption) (*MsgVoteReadResultResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ucallback.v1.Msg/VoteReadResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_VoteReadResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ucallback.v1.Msg/VoteReadResult",
	}
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ucallback.v1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgVoteReadResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgVoteReadResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgVoteReadResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgVoteReadResultResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgVoteReadResultResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgVoteReadResultResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
