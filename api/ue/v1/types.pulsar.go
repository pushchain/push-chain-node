...
var (
	...
	fd_UniversalPayload_sig_type                 protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_UniversalPayload_sig_type = md_UniversalPayload.Fields().ByName("sig_type")
}
...
func (x *fastReflection_UniversalPayload) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.SigType != 0 {
		value := protoreflect.ValueOfEnum((protoreflect.EnumNumber)(x.SigType))
		if !f(fd_UniversalPayload_sig_type, value) {
			return
		}
	}
}
...
func (x *fastReflection_UniversalPayload) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "ue.v1.UniversalPayload.deadline":
		return x.Deadline != ""
	case "ue.v1.UniversalPayload.sig_type":
		return x.SigType != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_UniversalPayload) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "ue.v1.UniversalPayload.sig_type":
		x.SigType = (SignatureType)(value.Enum())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ue.v1.UniversalPayload"))
		}
...
func (x *fastReflection_UniversalPayload) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ue.v1.UniversalPayload.sig_type":
		panic(fmt.Errorf("field sig_type of message ue.v1.UniversalPayload is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ue.v1.UniversalPayload"))
		}
...
func (x *fastReflection_UniversalPayload) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.SigType != 0 {
			n += 1 + runtime.Sov(uint64(x.SigType))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.SigType != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.SigType))
			i--
			dAtA[i] = 0x48
		}
		if len(x.Deadline) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 9:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field SigType", wireType)
				}
				x.SigType = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.SigType |= SignatureType(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
var (
	...
	fd_MethodConfig_method_type      protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MethodConfig_method_type = md_MethodConfig.Fields().ByName("method_type")
...
func (x *fastReflection_MethodConfig) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MethodType != 0 {
		value := protoreflect.ValueOfEnum((protoreflect.EnumNumber)(x.MethodType))
		if !f(fd_MethodConfig_method_type, value) {
			return
		}
	}
	if x.Identifier != "" {
...
func (x *fastReflection_MethodConfig) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "ue.v1.MethodConfig.name":
		return x.Name != ""
	case "ue.v1.MethodConfig.method_type":
		return x.MethodType != 0
	case "ue.v1.MethodConfig.identifier":
		return x.Identifier != ""
	case "ue.v1.MethodConfig.event_identifier":
...
func (x *fastReflection_MethodConfig) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "ue.v1.MethodConfig.method_type":
		x.MethodType = (GatewayMethodType)(value.Enum())
	case "ue.v1.MethodConfig.identifier":
...
func (x *fastReflection_MethodConfig) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ue.v1.MethodConfig.method_type":
		panic(fmt.Errorf("field method_type of message ue.v1.MethodConfig is not mutable"))
	case "ue.v1.MethodConfig.identifier":
		panic(fmt.Errorf("field identifier of message ue.v1.MethodConfig is not mutable"))
	case "ue.v1.MethodConfig.event_identifier":
		panic(fmt.Errorf("field event_identifier of message ue.v1.MethodConfig is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ue.v1.MethodConfig"))
		}
...
func (x *fastReflection_MethodConfig) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.MethodType != 0 {
			n += 1 + runtime.Sov(uint64(x.MethodType))
		}
		l = len(x.Identifier)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.MethodType != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MethodType))
			i--
			dAtA[i] = 0x10
		}
		if len(x.Name) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MethodType", wireType)
				}
				x.MethodType = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MethodType |= GatewayMethodType(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *fastReflection_ChainConfig) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "ue.v1.ChainConfig.gateway_address":
...
func (x *fastReflection_ChainConfig) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ue.v1.ChainConfig.gateway_address":
		panic(fmt.Errorf("field gateway_address of message ue.v1.ChainConfig is not mutable"))
	case "ue.v1.ChainConfig.block_confirmation":
...
const (
	GatewayMethodType_ADD_FUNDS GatewayMethodType = 0 // Add funds to the gateway (e.g., "add_funds", "addFunds")
)

// Enum value maps for GatewayMethodType.
var (
	GatewayMethodType_name = map[int32]string{
		0: "ADD_FUNDS",
	}
	GatewayMethodType_value = map[string]int32{
		"ADD_FUNDS": 0,
	}
)

func (x GatewayMethodType) Enum() *GatewayMethodType {
	p := new(GatewayMethodType)
	*p = x
	return p
}
...
func (GatewayMethodType) Descriptor() protoreflect.EnumDescriptor {
	return file_ue_v1_types_proto_enumTypes[2].Descriptor()
}

func (GatewayMethodType) Type() protoreflect.EnumType {
	return &file_ue_v1_types_proto_enumTypes[2]
}

func (x GatewayMethodType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GatewayMethodType.Descriptor instead.
...
type UniversalPayload struct {
	...
	SigType              SignatureType `protobuf:"varint,9,opt,name=sig_type,json=sigType,proto3,enum=ue.v1.SignatureType" json:"sig_type,omitempty"`                    // Type of signature verification
}
...
func (x *UniversalPayload) GetSigType() SignatureType {
	if x != nil {
		return x.SigType
	}
...
type MethodConfig struct {
	...
	MethodType      GatewayMethodType `protobuf:"varint,2,opt,name=method_type,json=methodType,proto3,enum=ue.v1.GatewayMethodType" json:"method_type,omitempty"` // Type of the method (enum)
	Identifier      string            `protobuf:"bytes,3,opt,name=identifier,proto3" json:"identifier,omitempty"`                                                 // Hex-encoded selector or discriminator for the method
	EventIdentifier string            `protobuf:"bytes,4,opt,name=event_identifier,json=eventIdentifier,proto3" json:"event_identifier,omitempty"`                // Hex-encoded topic or identifier for emitted event
}
...
func (x *MethodConfig) GetMethodType() GatewayMethodType {
	if x != nil {
		return x.MethodType
	}
...
var file_ue_v1_types_proto_rawDesc = []byte{
	...
	0x2a, 0x09, 0x75, 0x65, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0xce, 0x02, 0x0a, 0x10,
	...
	0x64, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x2f, 0x0a, 0x08, 0x73, 0x69, 0x67, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x75, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x54, 0x79, 0x70, 0x65,
	0x52, 0x07, 0x73, 0x69, 0x67, 0x54, 0x79, 0x70, 0x65, 0x3a, 0x21, 0x98, 0xa0, 0x1f, 0x00, 0xe8,
	0xa0, 0x1f, 0x01, 0x8a, 0xe7, 0xb0, 0x2a, 0x14, 0x75, 0x65, 0x2f, 0x75, 0x6e, 0x69, 0x76, 0x65,
	0x72, 0x73, 0x61, 0x6c, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x61, 0x0a, 0x10,
	...
	0x05, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x3a, 0x21, 0x98, 0xa0,
	...
	0xc7, 0x01, 0x0a, 0x0c, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x39, 0x0a, 0x0b, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x5f, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x75, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x54,
	...
	,
	...
	,
	...
	0x08, 0x2a, 0x44, 0x0a, 0x0d, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x54, 0x79,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x10, 0x01, 0x2a, 0x22, 0x0a, 0x11, 0x47, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0d, 0x0a, 0x09,
	0x41, 0x44, 0x44, 0x5f, 0x46, 0x55, 0x4e, 0x44, 0x53, 0x10, 0x00, 0x42, 0x79, 0x0a, 0x09, 0x63,
	0x6f, 0x6d, 0x2e, 0x75, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50,
...
var file_ue_v1_types_proto_goTypes = []interface{}{
	...
	(GatewayMethodType)(0),   // 2: ue.v1.GatewayMethodType
	(*Params)(nil),           // 3: ue.v1.Params
	(*UniversalPayload)(nil), // 4: ue.v1.UniversalPayload
	(*UniversalAccount)(nil), // 5: ue.v1.UniversalAccount
	(*MethodConfig)(nil),     // 6: ue.v1.MethodConfig
	(*ChainConfig)(nil),      // 7: ue.v1.ChainConfig
}
var file_ue_v1_types_proto_depIdxs = []int32{
	1, // 0: ue.v1.UniversalPayload.sig_type:type_name -> ue.v1.SignatureType
	2, // 1: ue.v1.MethodConfig.method_type:type_name -> ue.v1.GatewayMethodType
	0, // 2: ue.v1.ChainConfig.vm_type:type_name -> ue.v1.VM_TYPE
	6, // 3: ue.v1.ChainConfig.gateway_methods:type_name -> ue.v1.MethodConfig
