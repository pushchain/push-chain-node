...
echo "📁 Copying built binary to $BINARY_OUT_DIR/puniversald ..."
cp "$ROOT_DIR/build/puniversald" "$BINARY_OUT_DIR/puniversald"

echo "✅ Done. Linux binary available at: $BINARY_OUT_DIR/puniversald"
