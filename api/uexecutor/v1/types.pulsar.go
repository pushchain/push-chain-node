...
>>>>>>> e0e466f (refactor: renamed inbound_synthetic to inbound and added a tx_type in inbound):api/ue/v1/types.pulsar.go
)
...
>>>>>>> 045e53a (refactor: updated ue UniversalTx proto):api/ue/v1/types.pulsar.go
	if x != nil {
		return x.PcTx
	}
	return nil
