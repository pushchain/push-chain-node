...
export user1=$(pushchaind keys show user1 -a)
pushchaind genesis add-genesis-account $user1 500000000000npush --home ~/.tn/pn1
# user2 would own nothing
export user2=$(pushchaind keys show user2 -a)
pushchaind genesis add-genesis-account $user2 500000000000npush --home ~/.tn/pn1
...
pushchaind genesis gentx user1 10000000000npush --chain-id test-push-chain --home ~/.tn/pn1
# put all txs into genesis.json
pushchaind genesis collect-gentxs --home ~/.tn/pn1
