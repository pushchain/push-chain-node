...
func (m *SystemConfig) GetHandlerContractAddress() string {
	if m != nil {
		return m.HandlerContractAddress
	}
	return ""
}
...
var fileDescriptor_11eea54f17422d86 = []byte{
	...
	,
}
...
func (this *SystemConfig) Equal(that interface{}) bool {
	...
	if this.HandlerContractAddress != that1.HandlerContractAddress {
		return false
	}
	return true
}
...
func (m *SystemConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.HandlerContractAddress) > 0 {
		i -= len(m.HandlerContractAddress)
		copy(dAtA[i:], m.HandlerContractAddress)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.HandlerContractAddress)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SystemConfig) Size() (n int) {
	...
	var l int
	_ = l
	l = len(m.HandlerContractAddress)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
...
func (m *SystemConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HandlerContractAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HandlerContractAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
