...
import (
	...
	gaslessthing "github.com/rollchains/pchain/x/gaslessthing"
	gaslessthingkeeper "github.com/rollchains/pchain/x/gaslessthing/keeper"
	gaslessthingtypes "github.com/rollchains/pchain/x/gaslessthing/types"
...
type ChainApp struct {
	*baseapp.BaseApp
	...
	GaslessthingKeeper        gaslessthingkeeper.Keeper
...
func NewChainApp(
	...
	// Create the gaslessthing Keeper
	app.GaslessthingKeeper = gaslessthingkeeper.NewKeeper(
		appCodec,
		runtime.NewKVStoreService(keys[gaslessthingtypes.StoreKey]),
		logger,
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
		app.EVMKeeper,
	)
	...
	app.ModuleManager = module.NewManager(
		...
		gaslessthing.NewAppModule(appCodec, app.GaslessthingKeeper, app.EVMKeeper),
	)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(gaslessthingtypes.ModuleName)
