...
replace (
	...
	// github.com/cosmos/cosmos-sdk/x/auth => cosmossdk.io/x/auth v1.1.1
...
// Add these replacements to resolve module path issues
replace (
	github.com/cosmos/cosmos-sdk/client/grpc/cmtservice => github.com/cosmos/cosmos-sdk v0.47.3
	github.com/cosmos/cosmos-sdk/codec/address => github.com/cosmos/cosmos-sdk v0.47.3
)
