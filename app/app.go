...
import (
	...
	pchain "github.com/push.org/rollchain/x/pchain"
	pchainkeeper "github.com/push.org/rollchain/x/pchain/keeper"
	pchaintypes "github.com/push.org/rollchain/x/pchain/types"
)
...
type ChainApp struct {
	*baseapp.BaseApp
	...
	PchainKeeper pchainkeeper.Keeper
...
func NewChainApp(
	...
	// Create the pchain Keeper
	app.PchainKeeper = pchainkeeper.NewKeeper(
		appCodec,
		runtime.NewKVStoreService(keys[pchaintypes.StoreKey]),
		logger,
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
	)
	...
	app.ModuleManager = module.NewManager(
		...
		pchain.NewAppModule(appCodec, app.PchainKeeper),
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(pchaintypes.ModuleName)
