...
var (
	...
	fd_SystemConfig_universal_core_address protoreflect.FieldDescriptor
)

func init() {
	file_uregistry_v1_types_proto_init()
	md_SystemConfig = File_uregistry_v1_types_proto.Messages().ByName("SystemConfig")
	fd_SystemConfig_universal_core_address = md_SystemConfig.Fields().ByName("universal_core_address")
}
...
func (x *fastReflection_SystemConfig) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.UniversalCoreAddress != "" {
		value := protoreflect.ValueOfString(x.UniversalCoreAddress)
		if !f(fd_SystemConfig_universal_core_address, value) {
			return
		}
	}
}
...
func (x *fastReflection_SystemConfig) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "uregistry.v1.SystemConfig.universal_core_address":
		return x.UniversalCoreAddress != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_SystemConfig) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "uregistry.v1.SystemConfig.universal_core_address":
		x.UniversalCoreAddress = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: uregistry.v1.SystemConfig"))
		}
...
func (x *fastReflection_SystemConfig) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "uregistry.v1.SystemConfig.universal_core_address":
		panic(fmt.Errorf("field universal_core_address of message uregistry.v1.SystemConfig is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: uregistry.v1.SystemConfig"))
		}
...
func (x *fastReflection_SystemConfig) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.UniversalCoreAddress) > 0 {
			i -= len(x.UniversalCoreAddress)
			copy(dAtA[i:], x.UniversalCoreAddress)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.UniversalCoreAddress)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field UniversalCoreAddress", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.UniversalCoreAddress = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *SystemConfig) GetUniversalCoreAddress() string {
	if x != nil {
		return x.UniversalCoreAddress
	}
	return ""
...
var file_uregistry_v1_types_proto_rawDesc = []byte{
	...
	,
	...
	,
