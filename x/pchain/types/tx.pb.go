...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_8c9b512bbf252d8e, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8c9b512bbf252d8e, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "pchain.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "pchain.v1.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("pchain/v1/tx.proto", fileDescriptor_8c9b512bbf252d8e) }

var fileDescriptor_8c9b512bbf252d8e = []byte{
	// 323 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2a, 0x48, 0xce, 0x48,
	0xcc, 0xcc, 0xd3, 0x2f, 0x33, 0xd4, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2,
	...
	0xa3, 0x34, 0x49, 0x2f, 0x39, 0x3f, 0x57, 0xbf, 0xa0, 0xb4, 0x38, 0x43, 0x2f, 0xbf, 0x28, 0x5d,
	0xbf, 0x28, 0x3f, 0x27, 0x07, 0x12, 0x01, 0x15, 0xfa, 0xd0, 0x98, 0x28, 0xa9, 0x2c, 0x48, 0x2d,
	0x4e, 0x62, 0x03, 0x07, 0xaa, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xf1, 0x57, 0x95, 0x20, 0xd8,
	0x01, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pchain.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pchain.v1.Msg/UpdateParams",
	}
